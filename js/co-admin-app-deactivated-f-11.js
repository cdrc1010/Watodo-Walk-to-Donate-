        ...
        btnAccept.addEventListener('click', (e) => {
            ...
            db.collection('adminCollection').doc(id).get().then(doc => {
                ...
                Email.send({
                    ...
                    You may now login your account to manage our application!<br>
                    Have a good day!
                    `
                }).then(()=> {
                    Swal.fire({
...
db.collection('adminCollection').where('userType', '==', 'co-admin').where('status', '==', 'deactivated').orderBy('barangay').onSnapshot(snapshot => {
    let changes = snapshot.docChanges();
