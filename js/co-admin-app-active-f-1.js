...
function renderCafe(doc) {
    ...
    btnAccept.textContent = 'deactivate';
        ...
        btnAccept.addEventListener('click', (e) => {
            ...
            db.collection('adminCollection').doc(id).get().then(doc => {
                ...
                Email.send({
                    ...
                    Subject : "Your account currently disabled by the admin",
...
db.collection('adminCollection').where('userType', '==', 'co-admin').where('status', '==', 'activated').orderBy('barangay').onSnapshot(snapshot => {
    let changes = snapshot.docChanges();
